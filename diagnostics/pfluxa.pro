...
for k=0,ntmp-1 do begin
   yav(0,k) = (ytmp(0,2,k)+ytmp(0,3,k)+ytmp(0,4,k)+ytmp(0,5,k))/4
   yav(1,k) = (ytmp(1,2,k)+ytmp(1,3,k)+ytmp(1,4,k)+ytmp(1,5,k))/4
   yav(2,k) = (ytmp(2,2,k)+ytmp(2,3,k)+ytmp(2,4,k)+ytmp(2,5,k))/4
   yav(3,k) = (ytmp(3,2,k)+ytmp(3,3,k)+ytmp(3,4,k)+ytmp(3,5,k))/4         
endfor
...
print,'particle flux average=', ip,dum
y5 = ytmp
y5av = yav
...
xmax = max([   max(t0)   ])
ymax = max([   max(y5av(0:2,0:n5-1))   ])
ymin = min([   min(y5av(0:2,0:n5-1))   ])

plot, t0(0:n5-1),y5av(0,0:n5-1), title='', $
...
;oplot,t0(0:n5-1),y5av(1,0:n5-1)+y5av(2,0:n5-1),linestyle=0,color=hong
oplot,t0(0:n5-1),y5av(1,0:n5-1),linestyle=0,color=lu
